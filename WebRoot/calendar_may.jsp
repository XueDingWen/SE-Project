		...
		<main>
			<header class="codrops-header">
				...
				<nav class="codrops-demos">
					...
					<a class="current-demo link" href="calendar_may.jsp">五月</a>
			...
			<div class="calendar-wrap">
				...
				<div class="content">
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-1">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-2">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-3">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-4">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-5">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-6">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-7">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-8">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-9">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-10">read news now</a>
					</div>
					<div class="content__block">
						...
						<p class="content__meta">Marie von Ebner-Eschenbach</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-11">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-12">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-13">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-14">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-15">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-16">read news now</a>
					</div>
					<div class="content__block">
						...
						<p class="content__meta">Criss Jami</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-17">read news now</a>
					</div>
					<div class="content__block">
						...
						<p class="content__meta">Chuck Palahniuk</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-18">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-19">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-20">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Enemies</h3>
						<p class="content__description">Happy slaves are the bitterest enemies of freedom.</p>
						<p class="content__meta">Marie von Ebner-Eschenbach</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-21">read news now</a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-22">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Quaintly Free</h3>
						<p class="content__description">To have so little, and it of so little value, was to be quaintly free.</p>
						<p class="content__meta">Wallace Stegner</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-23">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">On A Level</h3>
						<p class="content__description">I've always felt that your belongings have never been on a level with you.</p>
						<p class="content__meta">George Eliot</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-24">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Experiences</h3>
						<p class="content__description">We all need new ideas, images, and experiences far more than we need new stoves or cars or computers.</p>
						<p class="content__meta">Bill Holm</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-25">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Entrenched</h3>
						<p class="content__description">We are being called upon to act against a prevailing culture, to undermine our own entrenched tendency to accumulate and to consume, and to refuse to define our individuality by our presumed ability to do whatever we want.</p>
						<p class="content__meta">Lyanda Lynn Haupt</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-26">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Happiness</h3>
						<p class="content__description">The way of the consumerist culture is to spend so much energy chasing happiness that it has none left to be happy.</p>
						<p class="content__meta">Criss Jami</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-27">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Working Jobs</h3>
						<p class="content__description">Advertising has us chasing cars and clothes, working jobs we hate so we can buy shit we don't need.</p>
						<p class="content__meta">Chuck Palahniuk</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-28">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Spending Billions</h3>
						<p class="content__description">Our economy is based on spending billions to persuade people that happiness is buying things, and then insisting that the only way to have a viable economy is to make things for people to buy so they’ll have jobs and get enough money to buy things.</p>
						<p class="content__meta">Philip Slater</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-29">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Principle Of Having</h3>
						<p class="content__description">The real opposition is that between the ego-bound man, whose existence is structured by the principle of having, and the free man, who has overcome his egocentricity.</p>
						<p class="content__meta">Erich Fromm</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-30">read news now</a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Enemies</h3>
						<p class="content__description">Happy slaves are the bitterest enemies of freedom.</p>
						<p class="content__meta">Marie von Ebner-Eschenbach</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=5-31">read news now</a>
					</div>
