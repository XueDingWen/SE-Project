		...
		<main>
			<header class="codrops-header">
				...
				<nav class="codrops-demos">
					...
					<a class="current-demo link" href="calendar_november.jsp">十一月</a>
			...
			<div class="calendar-wrap">
				<div class="calendar">
					...
					<div class="cube" data-bg-color="#E0ECF5" data-title="Enemies"></div>
					<div class="cube" data-bg-color="#EEDECD" data-title="Better World"></div>
					<div class="cube" data-bg-color="#DFD1F0" data-title="Quaintly Free"></div>
					<div class="cube" data-bg-color="#F2D9E6" data-title="On A Level"></div>
					<div class="cube" data-bg-color="#DFD1F0" data-title="Experiences"></div>
					<div class="cube" data-bg-color="#E0ECF5" data-title="Entrenched"></div>
					<div class="cube" data-bg-color="#F7E8ED" data-title="Happiness"></div>
					...
					<div class="cube" data-bg-color="#B8E6B3" data-title="Principle Of Having"></div>
				</div>
				<div class="content">
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-1"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-2"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-3"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-4"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-5"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-6"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-7"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-8"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-9"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-10"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<p class="content__meta">Marie von Ebner-Eschenbach</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-11"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-12"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-13"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-14"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-15"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-16"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<p class="content__meta">Criss Jami</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-17"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<p class="content__meta">Chuck Palahniuk</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-18"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-19"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-20"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Enemies</h3>
						<p class="content__description">Happy slaves are the bitterest enemies of freedom.</p>
						<p class="content__meta">Marie von Ebner-Eschenbach</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-21"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-22"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Quaintly Free</h3>
						<p class="content__description">To have so little, and it of so little value, was to be quaintly free.</p>
						<p class="content__meta">Wallace Stegner</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-23"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">On A Level</h3>
						<p class="content__description">I've always felt that your belongings have never been on a level with you.</p>
						<p class="content__meta">George Eliot</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-24"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Experiences</h3>
						<p class="content__description">We all need new ideas, images, and experiences far more than we need new stoves or cars or computers.</p>
						<p class="content__meta">Bill Holm</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-25"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Entrenched</h3>
						<p class="content__description">We are being called upon to act against a prevailing culture, to undermine our own entrenched tendency to accumulate and to consume, and to refuse to define our individuality by our presumed ability to do whatever we want.</p>
						<p class="content__meta">Lyanda Lynn Haupt</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-26"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Happiness</h3>
						<p class="content__description">The way of the consumerist culture is to spend so much energy chasing happiness that it has none left to be happy.</p>
						<p class="content__meta">Criss Jami</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-27"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Working Jobs</h3>
						<p class="content__description">Advertising has us chasing cars and clothes, working jobs we hate so we can buy shit we don't need.</p>
						<p class="content__meta">Chuck Palahniuk</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-28"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Spending Billions</h3>
						<p class="content__description">Our economy is based on spending billions to persuade people that happiness is buying things, and then insisting that the only way to have a viable economy is to make things for people to buy so they’ll have jobs and get enough money to buy things.</p>
						<p class="content__meta">Philip Slater</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-29"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Principle Of Having</h3>
						<p class="content__description">The real opposition is that between the ego-bound man, whose existence is structured by the principle of having, and the free man, who has overcome his egocentricity.</p>
						<p class="content__meta">Erich Fromm</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=11-30"><font color="black">read news now</font></a>
					</div>
