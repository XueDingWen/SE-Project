		...
		<main>
			<header class="codrops-header">
				...
				<nav class="codrops-demos">
					...
					<a class="current-demo link" href="calendar_december.jsp">十二月</a>
				</nav>
			</header>
			<div class="calendar-wrap">
				...
				<div class="content">
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-1"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-2"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-3"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-4"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-5"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-6"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-7"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-8"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-9"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-10"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<p class="content__meta">Marie von Ebner-Eschenbach</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-11"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-12"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-13"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-14"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-15"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-16"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<p class="content__meta">Criss Jami</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-17"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<p class="content__meta">Chuck Palahniuk</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-18"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-19"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-20"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Enemies</h3>
						<p class="content__description">Happy slaves are the bitterest enemies of freedom.</p>
						<p class="content__meta">Marie von Ebner-Eschenbach</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-21"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						...
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-22"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Quaintly Free</h3>
						<p class="content__description">To have so little, and it of so little value, was to be quaintly free.</p>
						<p class="content__meta">Wallace Stegner</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-23"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">On A Level</h3>
						<p class="content__description">I've always felt that your belongings have never been on a level with you.</p>
						<p class="content__meta">George Eliot</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-24"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Experiences</h3>
						<p class="content__description">We all need new ideas, images, and experiences far more than we need new stoves or cars or computers.</p>
						<p class="content__meta">Bill Holm</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-25"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Entrenched</h3>
						<p class="content__description">We are being called upon to act against a prevailing culture, to undermine our own entrenched tendency to accumulate and to consume, and to refuse to define our individuality by our presumed ability to do whatever we want.</p>
						<p class="content__meta">Lyanda Lynn Haupt</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-26"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Happiness</h3>
						<p class="content__description">The way of the consumerist culture is to spend so much energy chasing happiness that it has none left to be happy.</p>
						<p class="content__meta">Criss Jami</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-27"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Working Jobs</h3>
						<p class="content__description">Advertising has us chasing cars and clothes, working jobs we hate so we can buy shit we don't need.</p>
						<p class="content__meta">Chuck Palahniuk</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-28"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Spending Billions</h3>
						<p class="content__description">Our economy is based on spending billions to persuade people that happiness is buying things, and then insisting that the only way to have a viable economy is to make things for people to buy so they’ll have jobs and get enough money to buy things.</p>
						<p class="content__meta">Philip Slater</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-29"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Principle Of Having</h3>
						<p class="content__description">The real opposition is that between the ego-bound man, whose existence is structured by the principle of having, and the free man, who has overcome his egocentricity.</p>
						<p class="content__meta">Erich Fromm</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-30"><font color="black">read news now</font></a>
					</div>
					<div class="content__block">
						<h3 class="content__title">Enemies</h3>
						<p class="content__description">Happy slaves are the bitterest enemies of freedom.</p>
						<p class="content__meta">Marie von Ebner-Eschenbach</p>
						<a href="<%=basePath %>/c1/newslistbydate.action?date=12-31"><font color="black">read news now</font></a>
					</div>
